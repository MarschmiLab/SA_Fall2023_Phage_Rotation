...
congenee <- congenee %>% 
  ...
  select(Seq_Name, Bin, annotation_conjscan, conj_gene_type, fraction_class, estimated_length, Phylum)
...
congenee_type <- congenee %>%
  group_by(Seq_Name, conj_gene_type, fraction_class, Phylum, estimated_length) %>%
  summarise(
...
#aminoglycoside [doesnt work]
fargene -i /local/workdir/sna49/SA_Fall2023_Phage_Rotation/Data/fargene/*.fa --hmm-model aminoglycoside_model_a -o aminogly_a -p 30 
```
